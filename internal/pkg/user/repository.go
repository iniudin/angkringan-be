...
type Repository interface {
	...
	UpdatePhone(ctx context.Context, user User) (*User, error)
...
func (r *RepositoryImpl) UpdatePassword(ctx context.Context, user User) (*User, error) {
...
func (r *RepositoryImpl) UpdatePhone(ctx context.Context, user User) (*User, error) {
	_, err := r.db.ExecContext(
...
func (r *RepositoryImpl) FindAll(ctx context.Context, pageNumber int, pageSize int) (*[]User, error) {
	var users []User
...
func (r *RepositoryImpl) FindByPhone(ctx context.Context, phone string) (*User, error) {
	user := User{}
	result, err := r.db.QueryContext(
		ctx,
